...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Matka | Homemade Tiffin Service" },
      { name: "description", content: "Fresh, home-cooked Indian meal plans delivered warm across Pune." },
      { name: "author", content: "Matka Homemade Tiffin" },
      { property: "og:title", content: "Matka | Homemade Tiffin Service" },
      { property: "og:description", content: "Fresh, home-cooked Indian meal plans delivered warm across Pune." },
